      ...
      <div className="drawer-content">
        {params.id ? (
          <label htmlFor="my-drawer">
            <div className="w-[73px] text-center bg-[#F9FAFE] pt-[18px] pb-[15px] font-bold mobile:pt-[14] mobile:pb-[11px] text-light-violet rounded-full text-[15px] tracking-[-0.25px] active:opacity-70">
              {edit}
            </div>
          </label>
        ) : (
